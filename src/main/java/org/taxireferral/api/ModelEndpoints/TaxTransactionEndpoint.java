 ...
 */
public class TaxTransactionEndpoint {

    private int itemCount;
    private int offset;
    private int limit;
    private int max_limit;
    private List<TransactionTaxAccount> results;




    public List<TransactionTaxAccount> getResults() {
        return results;
    }

    public void setResults(List<TransactionTaxAccount> results) {
